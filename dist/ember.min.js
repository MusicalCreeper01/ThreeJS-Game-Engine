...
Ember.GameObject.Box=function(a,c,b){var d=new Ember.GameObject;d.mesh=void 0!=a&&void 0!=c&&void 0!=b?new THREE.BoxGeometry(a,c,b):void 0!=a?new THREE.BoxGeometry(a,a,a):new THREE.BoxGeometry(1,1,1);d.material=new THREE.MeshPhongMaterial;return d};Ember.GameObject.Circle=function(a,c){var b=new Ember.GameObject;b.mesh=void 0!=a&&void 0!=c?new THREE.CircleGeometry(a,c):void 0!=a?new THREE.CircleGeometry(a):new THREE.CircleGeometry(5,32);b.material=new THREE.MeshPhongMaterial;return b};
Ember.GameObject.Sphere=function(a,c,b){var d=new Ember.GameObject;d.mesh=void 0!=a&&void 0!=c&&void 0!=b?new THREE.SphereGeometry(a,c,b):void 0!=a?new THREE.SphereGeometry(a):new THREE.SphereGeometry(5,32,32);d.material=new THREE.MeshPhongMaterial;return d};
Ember.GameObject.Text=function(a,c){var b=new Ember.GameObject;if(void 0!=a&&void 0!=c)b.mesh=new THREE.TextGeometry(a,c);else if(void 0!=a){var d=new THREE.Font(JSON.parse(opensans.substring(65,opensans.length-2)));b.mesh=new THREE.TextGeometry(a,{font:d,size:5,height:5})}else b.mesh=new THREE.TextGeometry("This is some text!",{font:font,size:5,height:5});b.material=new THREE.MeshPhongMaterial;return b};Ember.Material=function(){var a=this;this.name="New Scene";this.shader=void 0;this.Events={};this.Events.OnChange=[];this.setShader=function(c){this.shader=c;this.Events.OnChange.forEach(function(b){void 0!=a._t&&a._tmat();b(a)})};this.texture=null;this.setTexture=function(c){this.texture=c;this.Events.OnChange.forEach(function(b){void 0!=a._t&&void 0!=a._t.map&&(a._t.map=c);b(a)})};this.color=new Ember.Color(255,255,255);this.setColor=function(c){c instanceof Ember.Color?(this.color=c,void 0!=a._t&&
...
Ember.Material.LoadRemote=function(a,c){var b={loaded:!1,progress:0,error:!1,material:d},d=new Ember.Material;d.name="Loaded Material";THREE.MaterialLoader.load(a,function(a){b.loaded=!0;d.override=a;void 0!=c&&c(d)},function(a){b.progress=a.loaded/a.total*100;console.log(a.loaded/a.total*100+"% loaded")},function(){b.error=!0});return b};Ember.Scene=function(){this.name="New Scene";this.objects=[];this.enviroment=new function(){this.ambientColor=3549;this.background={type:1,color:963304,skybox:new Ember.Material.Skybox("img/sky/posx.jpg img/sky/negx.jpg img/sky/posy.jpg img/sky/negy.jpg img/sky/posz.jpg img/sky/negz.jpg".split(" "))}};this.Events={};this.Events.ObjectAdded=[];this.add=function(a){this.objects.push(a);this.Events.ObjectAdded.forEach(function(c){c(a)})}};Ember.Vector2=function(a,c,b){this.y=this.x=0;void 0!=a&&void 0!=c?(this.x=a,this.y=c):void 0!=a&&(this.y=this.x=a);this.set=function(a,b){void 0!=a&&void 0!=b&&(this.x=a,this.y=b);return this}};Ember.Vector3=function(a,c,b){this.z=this.y=this.x=0;void 0!=a&&void 0!=c&&void 0!=b?(this.x=a,this.y=c,this.z=b):void 0!=a&&(this.z=this.y=this.x=a);this.set=function(a,b,c){void 0!=a&&void 0!=b&&void 0!=c&&(this.x=a,this.y=b,this.z=c);return this}};Ember.Util={};Array.prototype.indexOf||(Array.prototype.indexOf=function(a,c){var b;if(null==this)throw new TypeError('"this" is null or not defined');var d=Object(this),e=d.length>>>0;if(0===e)return-1;b=+c||0;Infinity===Math.abs(b)&&(b=0);if(b>=e)return-1;for(b=Math.max(0<=b?b:e-Math.abs(b),0);b<e;){if(b in d&&d[b]===a)return b;b++}return-1});Ember.Util.Color={fromHex:function(a){return hexToRgb(a)},toHex:function(a,c,b){return rgbToHex(a,c,b)}};function componentToHex(a){a=a.toString(16);return 1==a.length?"0"+a:a}function rgbToHex(a,c,b){return"#"+componentToHex(a)+componentToHex(c)+componentToHex(b)}
function hexToRgb(a){a=a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(a,b,d,e){return b+b+d+d+e+e});return(a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a))?{r:parseInt(a[1],16),g:parseInt(a[2],16),b:parseInt(a[3],16)}:null};Ember.Util.Transform={getSize:function(a,c,b){a instanceof Ember.Vector2||console.error("At the moment getSize is only avaliable for Vector2");b&&(b=c.offsetWidth,c=c.offsetHeight,console.log(b),console.log(a.x),a.x=a.x/100*b,a.y=a.y/100*c);return a}};Ember.UI=function(a){if(void 0==a)console.error("Ember.UI must be passed an instance of Ember");else if(void 0==a.element)console.error("ember.element MUST be set to initialize a UI!");else{var c=this,b=famous.core.Engine,d=famous.core.Surface;this.panels=[];this.active=!0;c.famous={};c.famous.context=b.createContext(a.element);this.addPanel=function(b){c.panels.push(b);var e=b.getSize(a.element),e=new d({size:[e.x,e.y],content:"Hello world",properties:{backgroundColor:b.color.toHex()}});c.famous.context.add(e);
b.famous={surface:e};b.remove=function(){return c.removePanel(b)};return b};this.removePanel=function(a){if(void 0==a.famous.surface)console.error("To remove a panel from a UI you nede to pass the panel object returned from the add call");else{a.famous.surface.render=function(){return null};delete a.famous;var b=c.panels.indexOf(a);-1<b&&c.panels.splice(b,1);return a}};this.draw=function(){}}};Ember.UI.Element=function(){var a=this;this.name="UI Element";this.position=new Ember.Vector2;this.rotation=new Ember.Vector3;this.size=new Ember.Vector2;this.sizepercent=!0;this.getSize=function(c){return Ember.Util.Transform.getSize(a.size,c,a.sizepercent)}};Ember.UI.Panel=function(){Ember.UI.Element.apply(this);this.elements=[];this.color=new Ember.Color("#00ff00")};
