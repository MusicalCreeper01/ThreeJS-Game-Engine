...
b=0;b<a.objects.length;++b)console.log(a.objects[b]._tmesh()),c.three.scene.add(a.objects[b]._tmesh());c.scene.Events.ObjectAdded.push(function(a){c.three.scene.add(a._tmesh())})};this.add=function(a){c.scenes.push(a)}};this.begin=function(){function a(){requestAnimationFrame(a);f.updateProjectionMatrix();e.setViewport(0,0,b,d);e.render(h,f)}c.three={};var b=c.element.offsetWidth,d=c.element.offsetHeight;void 0!=b&&0!=b&&void 0!=d&&0!=d||console.error("Width/Height of the game element is 0! ");console.log(b+
"/"+d);var h=new THREE.Scene;c.three.scene=h;var f=new THREE.PerspectiveCamera(75,b/d,.1,1E3);f.position.z=5;h.add(f);c.three.camera=f;var k=new THREE.AmbientLight(1092);console.log(k);h.add(k);var e=new THREE.WebGLRenderer({antialias:!0});e.setSize(b,d);c.element.appendChild(e.domElement);e.domElement.style.position="absolute";e.domElement.style.top="0";e.domElement.style.bottom="0";e.domElement.style.left="0";e.domElement.style.right="0";c.three.renderer=e;c.renderer={camera:f,ambient:k,WebGLRenderer:e};
window.addEventListener("resize",function(){b=c.element.offsetWidth;d=c.element.offsetHeight;f.aspect=b/d;f.updateProjectionMatrix();e.setSize(b,d)},!1);a()};this.save=function(){this.save=!0;return JSON.stringify(this)};this.load=function(a){a=JSON.parse(a);for(var b in a)this[b]=a[b]}}Ember.quaternions=!1;Ember.Color=function(a,b,c,d){this.r=255;this.g=86;this.b=0;this.a=1;this.Events={};this.Events.OnChange=[];this.set=function(a,b,c,d){var g=this;void 0!=a&&void 0!=b&&void 0!=c&&void 0!=d?(this.r=a,this.g=b,this.b=c,this.a=d):void 0!=a&&void 0!=b&&void 0!=c?(this.r=a,this.g=b,this.b=c):void 0!=a&&(void 0!=Ember.Util.Color?(a=Ember.Util.Color.fromHex(a),this.r=a.r,this.g=a.g,this.b=a.b):console.error("Hex input to the Ember.Color constructor is currently not supported due to the color utilities modules not being included"));
this.Events.OnChange.forEach(function(a){return a(g)})};void 0!=a&&void 0!=b&&void 0!=c&&void 0!=d?(this.r=a,this.g=b,this.b=c,this.a=d):void 0!=a&&void 0!=b&&void 0!=c?(this.r=a,this.g=b,this.b=c):void 0!=a&&(void 0!=Ember.Util.Color?(a=Ember.Util.Color.fromHex(a),this.r=a.r,this.g=a.g,this.b=a.b):console.error("Hex input to the Ember.Color constructor is currently not supported due to the color utilities modules not being included"));this.toHex=function(){if(void 0!=Ember.Util.Color)return Ember.Util.Color.toHex(this.r,
...
Ember.GameObject.Box=function(a,b,c){var d=new Ember.GameObject;d.mesh=void 0!=a&&void 0!=b&&void 0!=c?new THREE.BoxGeometry(a,b,c):void 0!=a?new THREE.BoxGeometry(a,a,a):new THREE.BoxGeometry(1,1,1);d.material=new THREE.MeshPhongMaterial;return d};Ember.GameObject.Circle=function(a,b){var c=new Ember.GameObject;c.mesh=void 0!=a&&void 0!=b?new THREE.CircleGeometry(a,b):void 0!=a?new THREE.CircleGeometry(a):new THREE.CircleGeometry(5,32);c.material=new THREE.MeshPhongMaterial;return c};
Ember.GameObject.Sphere=function(a,b,c){var d=new Ember.GameObject;d.mesh=void 0!=a&&void 0!=b&&void 0!=c?new THREE.SphereGeometry(a,b,c):void 0!=a?new THREE.SphereGeometry(a):new THREE.SphereGeometry(5,32,32);d.material=new THREE.MeshPhongMaterial;return d};
Ember.GameObject.Text=function(a,b){var c=new Ember.GameObject;if(void 0!=a&&void 0!=b)c.mesh=new THREE.TextGeometry(a,b);else if(void 0!=a){var d=new THREE.Font(JSON.parse(opensans.substring(65,opensans.length-2)));c.mesh=new THREE.TextGeometry(a,{font:d,size:5,height:5})}else c.mesh=new THREE.TextGeometry("This is some text!",{font:font,size:5,height:5});c.material=new THREE.MeshPhongMaterial;return c};Ember.Material=function(){var a=this;this.name="New Scene";this.shader=void 0;this.Events={};this.Events.OnChange=[];this.setShader=function(b){this.shader=b;this.Events.OnChange.forEach(function(b){void 0!=a._t&&a._tmat();b(a)})};this.texture=null;this.setTexture=function(b){this.texture=b;this.Events.OnChange.forEach(function(c){void 0!=a._t&&void 0!=a._t.map&&(a._t.map=b);c(a)})};this.color=new Ember.Color(255,255,255);this.setColor=function(b){b instanceof Ember.Color?(this.color=b,void 0!=a._t&&
...
Ember.Material.LoadRemote=function(a,b){var c={loaded:!1,progress:0,error:!1,material:d},d=new Ember.Material;d.name="Loaded Material";THREE.MaterialLoader.load(a,function(a){c.loaded=!0;d.override=a;void 0!=b&&b(d)},function(a){c.progress=a.loaded/a.total*100;console.log(a.loaded/a.total*100+"% loaded")},function(){c.error=!0});return c};Ember.Scene=function(){this.name="New Scene";this.objects=[];this.enviroment=new function(){this.ambientColor=3549;this.background={type:1,color:963304,skybox:new Ember.Material.Skybox("img/sky/posx.jpg img/sky/negx.jpg img/sky/posy.jpg img/sky/negy.jpg img/sky/posz.jpg img/sky/negz.jpg".split(" "))}};this.Events={};this.Events.ObjectAdded=[];this.add=function(a){this.objects.push(a);this.Events.ObjectAdded.forEach(function(b){b(a)})}};Ember.Vector2=function(a,b,c){this.y=this.x=0;void 0!=a&&void 0!=b?(this.x=a,this.y=b):void 0!=a&&(this.y=this.x=a);this.set=function(a,b){void 0!=a&&void 0!=b&&(this.x=a,this.y=b);return this}};Ember.Vector3=function(a,b,c){this.z=this.y=this.x=0;void 0!=a&&void 0!=b&&void 0!=c?(this.x=a,this.y=b,this.z=c):void 0!=a&&(this.z=this.y=this.x=a);this.set=function(a,b,c){void 0!=a&&void 0!=b&&void 0!=c&&(this.x=a,this.y=b,this.z=c);return this}};Ember.Util={};Ember.Util.Color={fromHex:function(a){return hexToRgb(a)},toHex:function(a,b,c){return rgbToHex(a,b,c)}};function componentToHex(a){a=a.toString(16);return 1==a.length?"0"+a:a}function rgbToHex(a,b,c){return"#"+componentToHex(a)+componentToHex(b)+componentToHex(c)}
function hexToRgb(a){a=a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(a,c,d,g){return c+c+d+d+g+g});return(a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a))?{r:parseInt(a[1],16),g:parseInt(a[2],16),b:parseInt(a[3],16)}:null};Ember.Util.Transform={getSize:function(a,b,c){a instanceof Ember.Vector2||console.error("At the moment getSize is only avaliable for Vector2");c&&(c=b.offsetWidth,b=b.offsetHeight,console.log(c),console.log(a.x),a.x=a.x/100*c,a.y=a.y/100*b);return a}};Ember.UI=function(a){if(void 0==a)console.error("Ember.UI must be passed an instance of Ember");else if(void 0==a.element)console.error("ember.element MUST be set to initialize a UI!");else{var b=this,c=famous.core.Engine,d=famous.core.Surface;this.panels=[];this.active=!0;b.famous={};b.famous.context=c.createContext(a.element);this.addPanel=function(c){b.panels.push(c);var g=c.getSize(a.element);c=new d({size:[g.x,g.y],content:"Hello world",properties:{backgroundColor:c.color.toHex()}});b.famous.context.add(c)};
this.draw=function(){}}};Ember.UI.Element=function(){var a=this;this.name="UI Element";this.position=new Ember.Vector2;this.rotation=new Ember.Vector3;this.size=new Ember.Vector2;this.sizepercent=!0;this.getSize=function(b){return Ember.Util.Transform.getSize(a.size,b,a.sizepercent)}};Ember.UI.Panel=function(){Ember.UI.Element.apply(this);this.elements=[];this.color=new Ember.Color("#00ff00")};
